...
/**
 * Created by Pradeep on 06-Aug-17.
 */

public class ReconstructionActivity extends AppCompatActivity {

    private static String TAG = "ReconstructionActivity";
    ...
    static ImageView camera2View;
    static TextView camera2Captured;
...
//        setSupportActionBar(toolbar);
    ...
    public final static ImageReader.OnImageAvailableListener imageAvailableListener = new ImageReader.OnImageAvailableListener() {
        ...
        public void onImageAvailable(ImageReader ir) {
            ...
            ReconstructionActivity.camera2View.setImageBitmap(bitmap);
    ...
    public boolean onCreateOptionsMenu(Menu menu) {
        ...
        getMenuInflater().inflate(R.menu.menu_reconstruction, menu);
        return true;
    }
    ...
    public boolean onOptionsItemSelected(MenuItem item) {
        ...
        if (id == R.id.action_settings_reconstruction) {
